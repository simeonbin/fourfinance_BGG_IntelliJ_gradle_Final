...
class ReadXMLGameDetails {
    ...
    static HashMap<Integer, Integer> mostVotedLanguageDependence = new HashMap<>();
    static Map.Entry entryWithMaxValue;

    public  Map.Entry<Integer, Integer> findKeyWithMaxValue( HashMap<Integer, Integer> map) {
                ...
                for (int i = 0; i < list.getLength(); i++) {
                    ...
                    if (node.getNodeType() == Node.ELEMENT_NODE) {
                        ...
                        if (el.getNodeName().contains("boardgame")) {
                            ...
                            entryWithMaxValue = findKeyWithMaxValue (mostVotedLanguageDependence);
